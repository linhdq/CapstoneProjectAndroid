...
public class CropWindow {
    ...
    private final static String LOG_TAG = CropWindow.class.getSimpleName();
    private final float[] mPoints = new float[8];
    private final float[] mMappedPoints = new float[8];
    private final Rect mImageRect;

    public CropWindow(RectF cropRect, Rect imageRect, float[] listPoints) {
        ...
        if (listPoints == null) {
            ...
            mPoints[0] = listPoints[0];
            mPoints[1] = listPoints[1];
            mPoints[2] = listPoints[2];
            mPoints[3] = listPoints[3];
            mPoints[4] = listPoints[4];
            mPoints[5] = listPoints[5];
            mPoints[6] = listPoints[6];
            mPoints[7] = listPoints[7];
        }
    }

    public void setListPoint(float[] listPoints) {
        mPoints[0] = listPoints[0];
        mPoints[1] = listPoints[1];
        mPoints[2] = listPoints[2];
        mPoints[3] = listPoints[3];
